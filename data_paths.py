...
# Fuzzing results subdirectories
...
def get_zero_day_file_path(plugin_slug: str, signature_id: str) -> Path:
    ...
    Args:
        plugin_slug: The plugin slug
        signature_id: The signature identifier

    Returns:
        Path object for the zero-day file
    """
...
def get_clone_timeline_path(signature_id: str) -> Path:
    ...
    Returns:
        Path object for the clone timeline file
    """
...
def get_metrics_file_path(signature_id: Optional[str] = None) -> Path:
    ...
    Args:
        signature_id: Optional signature identifier. If None, returns ecosystem metrics path.
...
def get_cache_file_path(plugin_slug: str, cache_type: str = "revisions") -> Path:
    ...
    Args:
        plugin_slug: The plugin slug
        cache_type: Type of cache ('revisions' or 'release_revisions')
...
def get_crash_dir_path(campaign_id: str) -> Path:
    ...
    Args:
        campaign_id: The fuzzing campaign identifier

    Returns:
        Path object for the crash directory
    """
...
def get_false_positive_file_path(plugin_slug: str, signature_id: str) -> Path:
    ...
    Returns:
        Path object for the false positive file
    """
...
def get_exploit_file_path(plugin_slug: str, signature_id: str) -> Path:
    ...
    Returns:
        Path object for the exploit file
    """
...
def get_research_report_path() -> Path:
    ...
    Returns:
        Path object for the research report file
    """
